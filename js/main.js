...
$(function () {
  ...
  $confess.click(function () {
    ...
    var $favor = $("input[name='favor']:checked").val();
    var $feeling = $("input[name='feeling']:checked").val();
    var result = '「' + results[$type][$favor][$feeling] + '」';
    var $result = $('#result');
    var $tweet = $('#tweet');
    var $line = $('#line');
    var tweetLink = "<a href='https://twitter.com/intent/tweet?text=" + encodeURIComponent(result) + "&hashtags=告白ジェネレーター https://yukihirai0505.github.io/simulation-confess/' target='_blank'>ツイートする</a>";
    var lineLink = "<a href='https://line.me/R/msg/text/?" + encodeURIComponent(result) + " https://yukihirai0505.github.io/simulation-confess/' target='_blank'>LINEでシェアする</a>";
